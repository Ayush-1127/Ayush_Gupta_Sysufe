...
// firebase link is addProvisioninged here
const appSetting = {
  databaseURL: "https://blog-2d8ec-default-rtdb.firebaseio.com/"
}
...
export default function Story() {
  ...
  function handleSubmit(e) {
    ...
    //this is added for toast notification
    toast('Story posted');
  ...
  // This is added
  // It is used to close the drop-down option whenever we click anywhere on the screen.
  // useRef hook is used
  let menuRef = useRef();
  useEffect(() => {
      ...
      <div className='story-section'>
        ...
        <section className='section-2'>
          ...
          <div className='section-2-head'>
            ...
            <div className='looking' ref={menuRef}>
